package poprice.wechat.util.ip;
...
public class IPSeeker {
	...
	private static final String IP_FILE = IPSeeker.class.getResource("/data/qqwry.dat").toString().substring(5);
	...
	private IPSeeker() {
		...
		try {
			...
			log.info(IPSeeker.class.getResource("/data/qqwry.dat").toString());
			log.info(IP_FILE);
